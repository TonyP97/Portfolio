...
return(
    <div id="contact" className="flex justify-center">
        <div className="w-60 sm:w-96 md:w-max lg:w-max xl:w-max">
            <h1 className="text-3xl font-bold text-center mb-6 text-yellow-400">Contacto</h1>
        <form onSubmit={onSubmit} className="w-full max-w-lg">
            <div class="flex flex-wrap -mx-3">
                ...
                <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" placeholder="Nombre" name='from_name' value={toSend.from_name} onChange={handleChange}/>
                ...
                <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" placeholder="Apellido" name='from_lastname' value={toSend.from_lastname} onChange={handleChange}/>
            ...
            <div className="mt-10 xl:hidden lg:hidden md:hidden sm:mt-10">
                <ul className="flex flex-wrap justify-center space-x-4 items-center">
                    ...
                    <li>
                        <a href="https://www.linkedin.com/in/agustin-pincheira/" target="_blank" className="block py-2 pr-4 pl-3 text-yellow-200 rounded hover:fill-yellow-400 md:hover:bg-transparent md:hover:text-yellow-400 md:p-0">
