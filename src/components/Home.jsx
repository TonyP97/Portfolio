...
return (
    ...
    {/* INGLES */}
        ...
        <main>
            <div className="my-24 mx-4 xl:mx-72 xl:max-w-6xl lg:mx-48 lg:max-w-6xl md:mx-44 md:max-w-6xl sm:mx-20 sm:max-w-6xl">
                <div className="xl:mt-72 xl:mb-96 lg:mt-72 lg:mb-96 md:mt-72 md:mb-96 sm:mt-72 sm:mb-96">
                    <div className="">
                        ...
                        <div className="flex flex-wrap justify-evenly mt-20">
                            ...
                            <img className="animate-[spin_1s]" src="https://raw.githubusercontent.com/devicons/devicon/1119b9f84c0290e0f0b38982099a2bd027a48bf1/icons/tailwindcss/tailwindcss-plain.svg" title="Tailwind" alt="Tailwind" width="60px" height="60px"/>
                        </div>
                    </div>
                </div>
                <div className="my-24 xl:mt-80 xl:mb-96 lg:mt-80 lg:mb-96 md:mt-80 md:mb-96 sm:mt-80 sm:mb-96">
